    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        <a href="<?= BASEURL ?>Home/asw/<?= $d['judul'] ?>" style="color: black;"><h5 class="card-title"><?= str_replace(["-"], ' ', $d['judul']); ?></h5></a>
                        <h6 class="card-subtitle mb-2 text-muted"><?= $d['time_create']; ?></h6>
                        <a href="<?= BASEURL ?>Home/asw/<?= $d['judul'] ?>" class="card-link" style="text-decoration: none;">Lihat lebih</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
